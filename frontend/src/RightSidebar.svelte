<!-- Right Sidebar -->
      <div
        ...
        x-on:keydown.window.escape="$store.global.isRightSidebarExpanded = false"
      >
        <div
          class="fixed inset-0 z-[150] bg-slate-900/60 transition-opacity duration-200"
          x-on:click="$store.global.isRightSidebarExpanded = false"
          x-show="$store.global.isRightSidebarExpanded"
          ...
          >
            ...
            >
              ...
              >
                ...
                <button
                  x-on:click="activeTab = 'tabProjects'"
                ...
                <button
                  x-on:click="activeTab = 'tabActivity'"
